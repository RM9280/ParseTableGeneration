...
public class ParseTable {
	public static void main(String[] args) {
		...
		ArrayList<String> text = readFile("problem1.txt");
		System.out.println(text);

		String[][] first = { { "(", "int" }, { "(", "int" }, { "+", "epsilon" }, { "(", "int" }, { "*", "epsilon" },
				{ "(", "int" } };
		String[][] follow = { { "$" }, { ")", "$" }, { ")", "$" }, { "+", ")", "$" }, { "+", ")", "$" },
				{ "+", "*", ")", "$" } };

		String[] left = { 		"P", 		"E", 			"E'", 			 "E'", 			"T", 		   "T'", 		  "T'", 		  "F", 			"F" };
		String[][] right = { { "E" }, { "T", "E'" }, { "+", "T", "E'" }, { "epsilon" }, {"F", "T'"}, {"*", "F", "T'"}, {"epsilon"}, {"(", "E", ")"}, { "int" } };
